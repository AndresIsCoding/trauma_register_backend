...
SECRET_KEY = os.getenv('SECRET_KEY', 'valor-por-defecto-seguro')
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:8000",  
    "http://localhost:3000",  # Cambia esto si necesitas usar otro puerto en desarrollo
    "http://localhost:5000",  
    f"http://localhost:{variable_frontend_port}", # Para el puerto variable en Flutter
]

# Permite añadir orígenes extra desde el .env
